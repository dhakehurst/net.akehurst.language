...
class test_multi_0_n_literal {
    ...
    fun empty() {
        ...
        this.check(s0.transitions(rrs, null), setOf(
                Transition(s0, s0.stateSet.fetch(RulePosition(r_a, 0, RulePosition.END_OF_RULE)), Transition.ParseAction.WIDTH, setOf(r_a,RuntimeRuleSet.END_OF_TEXT), null) { true },
        ...
        this.check(s2.transitions(rrs, s0.rulePosition), setOf(
                Transition(s2, s0.stateSet.fetch(RulePosition(s0.runtimeRule, 0, 1)), Transition.ParseAction.GRAFT, setOf(RuntimeRuleSet.END_OF_TEXT), RulePosition(s0.runtimeRule, 0, 0)) { true }
        ))
    }
    ...
    fun a() {
        ...
        this.check(s1.transitions(rrs, s0.rulePosition), setOf(
                Transition(s1, s0.stateSet.fetch(RulePosition(r_S, RuntimeRuleItem.MULTI__ITEM, RulePosition.MULIT_ITEM_POSITION)), Transition.ParseAction.HEIGHT, setOf(r_a, RuntimeRuleSet.END_OF_TEXT), RulePosition(r_S, RuntimeRuleItem.MULTI__ITEM, RulePosition.START_OF_RULE)) { true },
                Transition(s1, s0.stateSet.fetch(RulePosition(r_S, RuntimeRuleItem.MULTI__ITEM, RulePosition.END_OF_RULE)), Transition.ParseAction.HEIGHT, setOf(RuntimeRuleSet.END_OF_TEXT), RulePosition(r_S, RuntimeRuleItem.MULTI__ITEM, RulePosition.START_OF_RULE)) { true }
        ))
