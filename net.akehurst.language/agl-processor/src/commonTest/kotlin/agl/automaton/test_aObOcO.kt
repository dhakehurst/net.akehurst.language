...
internal class test_aObOcO : test_AutomatonAbstract() {
    ...
    fun parse_a() {
        ...
        val expected = automaton(rrs, AutomatonKind.LOOKAHEAD_1, "S", 0, false) {
            ...
            transition(s0, s1, s3, HEIGHT, setOf(UP,b,c), setOf(setOf(UP,b,c)), setOf( RP(aOpt, 0, SOR)))
            transition(s0, s3, s4, HEIGHT, setOf(UP,b,c), setOf(setOf(UP)), setOf( RP(S, 0, SOR)))
            transition(s0, s4, s5, WIDTH, setOf(UP,c), setOf(), null)
            transition(s0, s4, s6, WIDTH, setOf(UP,c), setOf(), null)
            transition(s4, s6, s7, HEIGHT, setOf(UP,c), setOf(setOf(UP,c)), setOf( RP(bOpt, 1, SOR)))
            transition(s4, s7, s8, GRAFT, setOf(UP,c), setOf(setOf(UP)), setOf( RP(S, 0, 1)))
            transition(s0, s8, s9, WIDTH, setOf(UP), setOf(), null)
            transition(s0, s8, s10, WIDTH, setOf(UP), setOf(), null)
            transition(s8, s10, s11, HEIGHT, setOf(UP), setOf(setOf(UP)), setOf( RP(cOpt, 1, SOR)))
            transition(s8, s11, s12, GRAFT, setOf(UP), setOf(setOf(UP)), setOf( RP(S, 0, 2)))
    ...
    fun parse_b() {
        ...
        val expected = automaton(rrs, AutomatonKind.LOOKAHEAD_1, "S", 0, false) {
            ...
            transition(s0, s0, s1, WIDTH, setOf(UP,b,c), setOf(), null)
            transition(s0, s0, s2, WIDTH, setOf(UP,b,c), setOf(), null)
            transition(s0, s2, s3, HEIGHT, setOf(UP,b,c), setOf(setOf(UP,b,c)), setOf( RP(aOpt, 1, SOR)))
            transition(s0, s3, s4, HEIGHT, setOf(UP,b,c), setOf(setOf(UP)), setOf( RP(S, 0, SOR)))
            transition(s0, s4, s5, WIDTH, setOf(UP,c), setOf(), null)
            transition(s0, s4, s6, WIDTH, setOf(UP,c), setOf(), null)
            transition(s4, s5, s7, HEIGHT, setOf(UP,c), setOf(setOf(UP,c)), setOf( RP(bOpt, 0, SOR)))
            transition(s4, s7, s8, GRAFT, setOf(UP,c), setOf(setOf(UP)), setOf( RP(S, 0, 1)))
            transition(s0, s8, s9, WIDTH, setOf(UP), setOf(), null)
            transition(s0, s8, s10, WIDTH, setOf(UP), setOf(), null)
            transition(s8, s10, s11, HEIGHT, setOf(UP), setOf(setOf(UP)), setOf( RP(cOpt, 1, SOR)))
    ...
    fun parse_c() {
        ...
        val expected = automaton(rrs, AutomatonKind.LOOKAHEAD_1, "S", 0, false) {
            ...
            transition(s0, s8, s9, WIDTH, setOf(UP), setOf(), null)
            transition(s0, s8, s10, WIDTH, setOf(UP), setOf(), null)
            transition(s8, s9, s11, HEIGHT, setOf(UP), setOf(setOf(UP)), setOf( RP(cOpt, 0, SOR)))
            transition(s8, s11, s12, GRAFT, setOf(UP), setOf(setOf(UP)), setOf( RP(S, 0, 2)))
            transition(s0, s12, s13, GOAL, setOf(UP), setOf(),null)
        }
        AutomatonTest.assertEquals(expected, actual)
    ...
    fun buildFor() {
        ...
        val expected = automaton(rrs, AutomatonKind.LOOKAHEAD_1, "S", 0, false) {
            ...
            transition(s5, s8, s10, GRAFT, setOf(UP,c), setOf(setOf(UP)), setOf( RP(S, 0, 1)))
            transition(s5, s9, s10, GRAFT, setOf(UP,c), setOf(setOf(UP)), setOf( RP(S, 0, 1)))
