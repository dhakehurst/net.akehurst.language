...
internal class test_aObOcO : test_AutomatonAbstract() {
    ...
    fun parse_b() {
        ...
        val expected = automaton(rrs, AutomatonKind.LOOKAHEAD_1, "S", false) {
            ...
            val s2 = state(RP(aOpt_E, 0, ER))
            val s3 = state(RP(aOpt, 1, ER))
            val s4 = state(RP(S, 0, 1))
            val s5 = state(RP(b, 0, ER))
            val s6 = state(RP(bOpt_E, 0, ER))
            val s7 = state(RP(bOpt, 0, ER))
            val s8 = state(RP(S, 0, 2))
            val s9 = state(RP(c, 0, ER))
            val s10 = state(RP(cOpt_E, 0, ER))
            val s11 = state(RP(cOpt, 1, ER))
            val s12 = state(RP(S, 0, ER))
            val s13 = state(RP(G, 0, ER))
    ...
    fun parse_c() {
        ...
        val expected = automaton(rrs, AutomatonKind.LOOKAHEAD_1, "S", false) {
            ...
            val s5 = state(RP(b, 0, ER))
            val s6 = state(RP(bOpt_E, 0, ER))
            val s7 = state(RP(bOpt, 1, ER))
            val s8 = state(RP(S, 0, 2))
            val s9 = state(RP(c, 0, ER))
            val s10 = state(RP(cOpt_E, 0, ER))
            val s11 = state(RP(cOpt, 0, ER))
            val s12 = state(RP(S, 0, ER))
            val s13 = state(RP(G, 0, ER))
    ...
    fun buildFor() {
        ...
        val expected = automaton(rrs, AutomatonKind.LOOKAHEAD_1, "S", false) {
            ...
            val s1 = state(RP(a, 0, ER))
            val s2 = state(RP(aOpt_E, 0, ER))
            val s3 = state(RP(aOpt, 0, ER))
            val s4 = state(RP(aOpt, 1, ER))
            val s5 = state(RP(S, 0, 1))
            val s6 = state(RP(b, 0, ER))
            val s7 = state(RP(bOpt_E, 0, ER))
            val s8 = state(RP(bOpt, 0, ER))
            val s9 = state(RP(bOpt, 1, ER))
            val s10 = state(RP(S, 0, 2))
            val s11 = state(RP(c, 0, ER))
            val s12 = state(RP(cOpt_E, 0, ER))
            val s13 = state(RP(cOpt, 0, ER))
            val s14 = state(RP(cOpt, 1, ER))
            val s15 = state(RP(S, 0, ER))
            val s16 = state(RP(G, 0, ER))
