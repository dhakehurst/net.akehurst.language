...
internal class test_rightRecursive : test_AutomatonAbstract() {
    ...
    private companion object {
        ...
        val s2 = SM.createState(listOf(RuleOptionPosition(S, 0, RuleOptionPosition.END_OF_RULE)))
        val s3 = SM.createState(listOf(RuleOptionPosition(S1, 0, 1)))
        val s4 = SM.createState(listOf(RuleOptionPosition(S1, 0, RuleOptionPosition.END_OF_RULE)))
        val s5 = SM.createState(listOf(RuleOptionPosition(G, 0, RuleOptionPosition.END_OF_RULE)))
        val s6 = SM.createState(listOf(RuleOptionPosition(S, 1, RuleOptionPosition.END_OF_RULE)))
