...
class test_Java8Agl_Annotations(val data:Data) {
    ...
    companion object {
        ...
        val processor : LanguageProcessor by lazy {
            Agl.processorFromStringForGoal(grammarStr, "Annotations.Annotation")
        }
        ...
        fun data(): Collection<Array<Any>> {
            ...
            for (sourceFile in sourceFiles) {
                val inps = test_Java8Agl_Annotations::class.java.getResourceAsStream(sourceFile)
