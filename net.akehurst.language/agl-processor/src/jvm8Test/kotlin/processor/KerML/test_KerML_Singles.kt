...
class test_KerML_Singles {
    ...
    private companion object {
        ...
        private val grammarStr = this::class.java.getResource("/KerML/std-v2_2023-08/grammar.agl").readText()
    ...
    @Test
    fun parse_grammar() {
        val grammarStr = this::class.java.getResource("/KerML/std-v2_2023-08/grammar.agl").readText()
