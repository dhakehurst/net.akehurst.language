...
import net.akehurst.language.objectgraph.api.ExternalGetter
import net.akehurst.language.objectgraph.api.FunctionLib
import net.akehurst.language.objectgraph.api.PrimitiveExecutor
import net.akehurst.language.types.api.TypesDomain

open class ObjectGraphAccessorMutatorAsmSimple2(
