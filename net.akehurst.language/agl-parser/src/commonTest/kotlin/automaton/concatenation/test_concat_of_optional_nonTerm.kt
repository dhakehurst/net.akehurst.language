...
class test_concat_of_optional_nonTerm : test_AutomatonAbstract() {
    ...
    fun parse_bcd() {
        ...
        val expected = automaton(rrs, AutomatonKind.LOOKAHEAD_1, "S", false) {
            ...
            val s4 = state(S,oN,1)
            val s5 = state(T_b,oN,EOR)
            val s6 = state(B,oN,1)
            val s7 = state(T_c,oN,EOR)
            val s8 = state(L,oN,1)
            val s9 = state(T_e,oN,EOR)
            val s10 = state(E_Es,oN,EOR)
            val s11 = state(Es,oSI,EOR)
            val s12 = state(L,oN,2)
            val s13 = state(T_d,oN,EOR)
    ...
    fun parse_abcd() {
        ...
        val expected = automaton(rrs, AutomatonKind.LOOKAHEAD_1, "S", false) {
            ...
            val s4 = state(S,oN,1)
            val s5 = state(T_b,oN,ER)
            val s6 = state(B,oN,1)
            val s7 = state(T_c,oN,ER)
            val s8 = state(L,oN,1)
            val s9 = state(T_e,oN,ER)
            val s10 = state(E_Es,oN,ER)
            val s11 = state(Es,oSI,ER)
            val s12 = state(L,oN,2)
            val s13 = state(T_d,oN,ER)
