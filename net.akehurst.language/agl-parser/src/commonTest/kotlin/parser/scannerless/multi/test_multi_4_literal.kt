...
class test_multi_4_literal : test_LeftCornerParserAbstract() {
    ...
    fun aaa_fails() {
        ...
        assertNull(sppt)
        assertEquals(listOf(
            parseError(InputLocation(3, 4, 1, 1, null),sentence, setOf("'a'"), setOf("'a'"))
        ),issues.errors)
    }
    ...
    fun aaaaa_fails() {
        ...
        assertNull(sppt)
        assertEquals(listOf(
            parseError(InputLocation(4, 5, 1, 1, null),sentence, setOf("'a'"), setOf("<EOT>"))
        ),issues.errors)
    }
}