...
class test_Processor_Ambiguity4 : test_LeftCornerParserAbstract() {
    ...
    fun n_empty_fails() {
        ...
        assertEquals(
            listOf(
                parseError(InputLocation(0, 1, 1, 1, null), sentence, setOf("<GOAL>"), setOf("n"))
            ), issues.errors
        )
    }
    ...
    fun S_with_non_empty_RList_bad_n_fails() {
        ...
        assertEquals(
            listOf(
                parseError(InputLocation(6, 7, 1, 1, null), sentence, setOf("S"), setOf("n"))
            ), issues.errors
        )
    }
    ...
    fun S_with_non_empty_p_and_non_empty_RList_bad_n_fails() {
        ...
        assertEquals(
            listOf(
                parseError(InputLocation(9, 10, 1, 1, null), sentence, setOf("S"), setOf("n"))
            ), issues.errors
        )
