...
public class ChoicePriorityDefault extends ChoiceAbstract implements ChoicePriority {

    public ChoicePriorityDefault(final ConcatenationDefault... alternative) {
        super(alternative);
    }
    ...
    public boolean equals(final Object arg) {
        if (arg instanceof ChoicePriorityDefault) {
            final ChoicePriorityDefault other = (ChoicePriorityDefault) arg;
