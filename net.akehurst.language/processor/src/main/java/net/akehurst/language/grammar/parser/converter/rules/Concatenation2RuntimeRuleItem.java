...
public class Concatenation2RuntimeRuleItem implements BinaryRule<ConcatenationDefault, RuntimeRuleItem> {

    @Override
    public boolean isValidForLeft2Right(final ConcatenationDefault arg0) {
        return true;
    }

    @Override
    public boolean isAMatch(final ConcatenationDefault left, final RuntimeRuleItem right, final BinaryTransformer transformer) {
        // TODO Auto-generated method stub
        return false;
    }

    @Override
    public RuntimeRuleItem constructLeft2Right(final ConcatenationDefault left, final BinaryTransformer transformer) {
    ...
    @Override
    public void updateLeft2Right(final ConcatenationDefault left, final RuntimeRuleItem right, final BinaryTransformer transformer) {
        final List<ConcatenationItemAbstract> tis = left.getItem();

        List<? extends RuntimeRule> rr = transformer.transformAllLeft2Right(
                (Class<? extends BinaryRule<ConcatenationItemAbstract, RuntimeRule>>) (Class<?>) AbstractConcatinationItem2RuntimeRule.class, tis);
        if (rr.isEmpty()) {
            // add an EMPTY_RULE
    ...
    @Override
    public void updateRight2Left(final ConcatenationDefault arg0, final RuntimeRuleItem arg1, final BinaryTransformer transformer) {
        // TODO Auto-generated method stub

    }

    @Override
    public ConcatenationDefault constructRight2Left(final RuntimeRuleItem arg0, final BinaryTransformer transformer) {
        // TODO Auto-generated method stub
        return null;
    }
