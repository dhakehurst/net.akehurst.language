...
public class test_Processor {
    ...
    private static final LanguageProcessor<Asm, SentenceContext> proc = Agl.INSTANCE.processorFromStringSimpleJava(
            grammarStr,
            null,
            null,
            null,
    ...
    public void semanticAnalysis() {
        ...
        SemanticAnalysisResult result = proc.semanticAnalysis(synt.getAsm(), Agl.INSTANCE.options(new ProcessOptionsDefault<>(), b ->{
            b.semanticAnalysis(b2->{
                b2.context(new SentenceContext());
                return Unit.INSTANCE;
            });
            return Unit.INSTANCE;
        }));
    ...
    public void process_defaultOptions() {
        ProcessOptions<Asm, SentenceContext> options = proc.optionsDefault();
