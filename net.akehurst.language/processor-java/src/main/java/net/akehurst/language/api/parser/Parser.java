...
public interface Parser {
     ...
     */
    SharedPackedParseTree parse(String goalRuleName, CharSequence inputText);

    SharedPackedParseTree parse(String goalRuleName, Reader inputText);

    List<RuleItem> expectedAt(String goalRuleName, CharSequence inputText, long position);

    List<RuleItem> expectedAt(String goalRuleName, Reader reader, long position);
}
