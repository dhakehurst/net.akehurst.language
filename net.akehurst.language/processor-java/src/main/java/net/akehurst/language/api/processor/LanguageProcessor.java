...
public interface LanguageProcessor {
    ...
    <T> T process(String text, String goalRuleName, Class<T> targetType);

    <T> T process(Reader reader, String goalRuleName, Class<T> targetType);
     ...
     */
    List<CompletionItem> expectedAt(String text, String goalRuleName, long position, long desiredDepth);

    List<CompletionItem> expectedAt(Reader reader, String goalRuleName, long position, long desiredDepth);
}
