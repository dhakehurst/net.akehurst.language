...
public class RuleNodeTypeDefault implements NodeType {

    private final NodeTypeIdentity identity;

    public RuleNodeTypeDefault(final Rule rule) {
    ...
    public boolean equals(final Object arg) {
        if (arg instanceof RuleNodeTypeDefault) {
            final RuleNodeTypeDefault other = (RuleNodeTypeDefault) arg;
