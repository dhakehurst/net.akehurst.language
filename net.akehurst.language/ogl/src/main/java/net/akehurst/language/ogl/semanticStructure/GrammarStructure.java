...
public class GrammarStructure implements Grammar {

	public GrammarStructure(final Namespace namespace, final String name) {
	...
	List<GrammarStructure> extends_;

	public List<GrammarStructure> getExtends() {
		return this.extends_;
	}

	public void setExtends(final List<GrammarStructure> value) {
		this.extends_ = value;
	}
	...
	public List<Rule> getAllRule() {
		...
		for (final GrammarStructure pg : this.getExtends()) {
	...
	public boolean equals(final Object arg) {
		if (arg instanceof GrammarStructure) {
			final GrammarStructure other = (GrammarStructure) arg;
