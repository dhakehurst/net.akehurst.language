...
public class Node2ChoiceSimple extends AbstractNode2Choice<ChoiceSimple> {
    ...
    @Override
    public boolean isAMatch(final SPPTBranch left, final ChoiceSimple right, final BinaryTransformer transformer) {
        // TODO Auto-generated method stub
        return false;
    }

    @Override
    public ChoiceSimple constructLeft2Right(final SPPTBranch left, final BinaryTransformer transformer) {
    ...
    @Override
    public SPPTBranch constructRight2Left(final ChoiceSimple right, final BinaryTransformer transformer) {
        // TODO Auto-generated method stub
        return null;
    }

    @Override
    public void updateLeft2Right(final SPPTBranch left, final ChoiceSimple right, final BinaryTransformer transformer) {
        // TODO Auto-generated method stub

    }

    @Override
    public void updateRight2Left(final SPPTBranch left, final ChoiceSimple right, final BinaryTransformer transformer) {
        // TODO Auto-generated method stub
