...
public class Concatenation2RuntimeRuleItem implements BinaryRule<Concatenation, RuntimeRuleItem> {
    ...
    @Override
    public boolean isAMatch(final Concatenation left, final RuntimeRuleItem right, final BinaryTransformer transformer) {
        // TODO Auto-generated method stub
        return false;
    }

    @Override
    public RuntimeRuleItem constructLeft2Right(final Concatenation left, final BinaryTransformer transformer) {
    ...
    @Override
    public void updateLeft2Right(final Concatenation left, final RuntimeRuleItem right, final BinaryTransformer transformer) {
        final List<ConcatenationItem> tis = left.getItem();

        List<? extends RuntimeRule> rr = transformer.transformAllLeft2Right(
                (Class<? extends BinaryRule<ConcatenationItem, RuntimeRule>>) (Class<?>) AbstractConcatinationItem2RuntimeRule.class, tis);
        if (rr.isEmpty()) {
            // add an EMPTY_RULE
    ...
    @Override
    public void updateRight2Left(final Concatenation arg0, final RuntimeRuleItem arg1, final BinaryTransformer transformer) {
        // TODO Auto-generated method stub

    }

    @Override
    public Concatenation constructRight2Left(final RuntimeRuleItem arg0, final BinaryTransformer transformer) {
        // TODO Auto-generated method stub
        return null;
    }
