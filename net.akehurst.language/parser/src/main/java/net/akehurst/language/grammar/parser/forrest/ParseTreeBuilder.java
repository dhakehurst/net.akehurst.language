...
public class ParseTreeBuilder {
	...
	public ParseTreeBuilder(final RuntimeRuleSetBuilder runtimeRules, final GrammarStructure grammar, final String goal, final CharSequence text, final int offset) {
