...
abstract public class AbstractGraphNode_old implements IGraphNode {

	public AbstractGraphNode_old(IParseGraph graph, int runtimeRuleNumber, int startPosition) {
		this.graph = graph;
		this.runtimeRuleNumber = runtimeRuleNumber;
...
//		this.parents = new HashMap<>();
	...
	int runtimeRuleNumber;
	int startPosition;
	int matchedTextLength;
