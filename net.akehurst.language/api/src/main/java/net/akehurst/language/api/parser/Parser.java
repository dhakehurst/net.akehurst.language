...
public interface Parser {
    ...
    List<RuleItem> expectedAt(String goalRuleName, CharSequence inputText, int position) throws ParseFailedException, ParseTreeException;

    List<RuleItem> expectedAt(String goalRuleName, Reader reader, int position) throws ParseFailedException, ParseTreeException;
}
